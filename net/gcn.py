...
class Model(nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, hidden_dim, num_class, graph_args,
        ...
        self.l4 = TCN_GCN_unit(hidden_channels, hidden_channels, A,stride=2, adaptive=True)
        self.l5 = TCN_GCN_unit(hidden_channels, 2*hidden_channels, A, adaptive=True)
        self.l6 = TCN_GCN_unit(2*hidden_channels, hidden_dim, A,adaptive=True)
